...
sudo scutil --set ComputerName "DanBookPro"
sudo scutil --set HostName "DanBookPro"
sudo scutil --set LocalHostName "DanBookPro"
...
# Stop safari opening the same tabs from last quit
